...
void loop()
{
  ...
  Serial.println("Sending a humidity data transmit:");
  ...
  label = "pmA:_";
  sensorValue = pm10;
  Serial.println("Sending a pm10 data transmit:");
  myTransmit(header, label, sensorValue);
  ...
  label = "pmB:_";
  sensorValue = pm25;
  Serial.println("Sending a pm25 data transmit:");
  myTransmit(header, label, sensorValue);
  ...
  label = "pmC:_";
  sensorValue = pm100;
  Serial.println("Sending a pm100 data transmit:");
  myTransmit(header, label, sensorValue);
  ...
  yield();
  label = "coTwo:_";
  sensorValue = co2div10;
  Serial.println("Sending a co2 data transmit:");
  myTransmit(header, label, sensorValue);
  ...
  Serial.println("Sending temperature data transmit:");
  myTransmit(header, label, sensorValue);
...
float takeReadings()
{
  ...
  if (error) 
  {
    ...
    Serial.print("PM_1.0:"); Serial.print(pm10); Serial.print(", ");
    Serial.print("PM_2.5:"); Serial.print(pm25); Serial.print(", ");
    Serial.print("PM_10:"); Serial.print(pm100); Serial.print(", ");
    Serial.print("co2div10:"); Serial.print(co2div10); Serial.print(", ");
