...
void loop() 
{
  ...
  if ((tempInt >= 0) && (tempInt < 5) && (started == true))
  {
    blinkBlueLED();
    digitalWrite(pink_pin,LOW);
    // digitalWrite(blue_pin,LOW);
  ...
  if ((tempInt >= 5) && (tempInt < 10) && (started == true))
  {
    blinkGreenLED();
    digitalWrite(pink_pin,LOW);
    digitalWrite(blue_pin,LOW);
  ...
  if ((tempInt >= 10) && (tempInt < 15) && (started == true))
  {
    blinkYellowLED();
    digitalWrite(pink_pin,LOW);
    digitalWrite(blue_pin,LOW);
  ...
  if ((tempInt >= 15) && (tempInt < 35) && (started == true))
  {
    blinkOrangeLED();
    digitalWrite(pink_pin,LOW);
    digitalWrite(blue_pin,LOW);
