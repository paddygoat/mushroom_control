#!/usr/bin/env python
# cd /home/paddy/Documents/Mushrooms && python3 data_rx_control_room_08.py
...
def animate(i, xs, yhum, ytempCon, ycoTwo, ypmA, ypmB, ypmC, ytempGlass, ymoisGlass, data_y_hum, data_y_tempCon, data_y_coTwo, data_y_pmA, data_y_pmB, data_y_pmC, data_y_tempGlass, data_y_moisGlass, threeDArray, counter, counter2, delta_time, errorCount):
    # Make a call back:
    # ser.write(b'S\n')
    ...
    if len_char_data >2 and len_char_data <50:
        ...
        ypmB = ypmB[-2880:]
        ypmC = ypmC[-2880:]
        ytempGlass = ytempGlass[-2880:]
        ymoisGlass = ymoisGlass[-2880:]
...
ani = animation.FuncAnimation(fig, animate, fargs=(xs, yhum, ytempCon, ycoTwo, ypmA, ypmB, ypmC, ytempGlass, ymoisGlass, data_y_hum, data_y_tempCon, data_y_coTwo, data_y_pmA, data_y_pmB, data_y_pmC, data_y_tempGlass, data_y_moisGlass, threeDArray, counter, counter2, delta_time, errorCount), interval=50)
plt.show()
