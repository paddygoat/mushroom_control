...
# data_y_hum, data_y_tempCon, data_y_coTwo, data_y_pmA, data_y_pmB, data_y_pmC,

# This function is called periodically from FuncAnimation
def animate(i, xs, yhum, ytempCon, ycoTwo, ypmA, ypmB, ypmC, data_y_hum, data_y_tempCon, data_y_coTwo, data_y_pmA, data_y_pmB, data_y_pmC, threeDArray, counter, counter2, delta_time, errorCount):
    # Make a call back:
    # ser.write(b'S\n')
...
ani = animation.FuncAnimation(fig, animate, fargs=(xs, yhum, ytempCon, ycoTwo, ypmA, ypmB, ypmC, data_y_hum, data_y_tempCon, data_y_coTwo, data_y_pmA, data_y_pmB, data_y_pmC, threeDArray, counter, counter2, delta_time, errorCount), interval=50)
plt.show()
